...
class TicTacToe:
    ...
    def edit_square(self, grid_coord):
        # swaps coordinates such as "1A" to "A1"
    ...
    def check_valid(self, move):
        ...
        if "A" in move:
            if "1" in move:
                if self.symbol_list[0] != " ":
                    return False
            elif "2" in move:
                if self.symbol_list[3] != " ":
                    return False
            elif "3" in move:
                if self.symbol_list[6] != " ":
                    return False
            else:
                return False
        elif "B" in move:
            if "1" in move:
                if self.symbol_list[1] != " ":
                    return False
            elif "2" in move:
                if self.symbol_list[4] != " ":
                    return False
            elif "3" in move:
                if self.symbol_list[7] != " ":
                    return False
            else:
                return False
        elif "C" in move:
            if "1" in move:
                if self.symbol_list[2] != " ":
                    return False
            elif "2" in move:
                if self.symbol_list[5] != " ":
                    return False
            elif "3" in move:
                if self.symbol_list[8] != " ":
                    return False
            else:
                return False
        else:
    ...
    def is_draw(self):
        ...
        if not self.did_win(self.player_symbol) and num_blanks == 0:
            return True
        else:
            return False
